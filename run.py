...
def parse_arguments():
    ...
    parser.add_argument('--multimodal_method', type=str, default='dlla', help="which method to use.")

    parser.add_argument('--method', type=str, default='dlla', help="which method to use.")
    ...
    parser.add_argument("--config_file_name", type=str, default='dlla.py', help = "The name of the config file.")
